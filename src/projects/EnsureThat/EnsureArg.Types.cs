...
namespace EnsureThat
{
    public static partial class EnsureArg
    {
        ...
        [NotNull]
        public static object IsOfType([ValidatedNotNull] object param, Type expectedType, bool allowSubclasses = false, [InvokerParameterName] string paramName = null, OptsFn optsFn = null)
            => Ensure.Type.IsOfType(param, expectedType, allowSubclasses, paramName, optsFn);

        [NotNull]
        public static Type IsOfType([ValidatedNotNull]Type param, Type expectedType, bool allowSubclasses = false, [InvokerParameterName] string paramName = null, OptsFn optsFn = null)
            => Ensure.Type.IsOfType(param, expectedType, allowSubclasses, paramName, optsFn);
