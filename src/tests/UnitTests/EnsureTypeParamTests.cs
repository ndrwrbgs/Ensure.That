...
namespace UnitTests
{
    public class EnsureTypeParamTests : UnitTestBase
    {
        ...
        public void IsOfType_WhenNotTypeOf_ThrowsArgumentException() => AssertIsOfTypeScenario(
            ...
            () => Ensure.Type.IsOfType(typeof(Bogus), NonBogusType, paramName: ParamName),
            () => Ensure.Type.IsOfType(new Bogus(), NonBogusType, paramName: ParamName),
        ...
        public void IsOfType_WhenIsCorrectType_It_should_not_throw() => ShouldNotThrow(
            () => Ensure.Type.IsOfType(BogusType, BogusType, paramName: ParamName),
            () => Ensure.Type.IsOfType(new Bogus(), BogusType, paramName: ParamName),
        ...
        public void IsOfType_WhenIsSubclass_ThrowsArgumentException() => AssertIsOfTypeScenario(
            ...
            () => Ensure.Type.IsOfType(typeof(Bogus), typeof(object), paramName: ParamName),
            () => Ensure.Type.IsOfType(new Bogus(), typeof(object), paramName: ParamName),
            () => EnsureArg.IsOfType(typeof(Bogus), typeof(object), paramName: ParamName),
            () => EnsureArg.IsOfType(new Bogus(), typeof(object), paramName: ParamName),
            () => Ensure.ThatType(typeof(Bogus), ParamName).IsOfType(typeof(object)),
            () => Ensure.ThatTypeFor(new Bogus(), ParamName).IsOfType(typeof(object)));
